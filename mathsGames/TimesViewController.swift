...
class TimesViewController: UIViewController {
    ...
    func randomNumbers() {
        ...
        firstNum = Int(arc4random_uniform(10))
        secondNum = Int(arc4random_uniform(10))
        answer = firstNum * secondNum
        
        wrongAnswer1 = Int(arc4random_uniform(10))
        wrongAnswer2 = Int(arc4random_uniform(10))
    ...
    func randomNumberChecks() {
        ...
        if answer == wrongAnswer1 || answer == wrongAnswer2 || answer == wrongAnswer3 || wrongAnswer1 == wrongAnswer2 || wrongAnswer2 == wrongAnswer3 || wrongAnswer1 == wrongAnswer3 {
            ...
            wrongAnswer1 = Int(arc4random_uniform(15))
            wrongAnswer2 = Int(arc4random_uniform(15))
            wrongAnswer3 = Int(arc4random_uniform(12))
    ...
    func printQ() {
        ...
        lblQuestion.text = "\(firstNum) x \(secondNum) = ?"
